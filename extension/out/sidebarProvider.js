...
class SidebarProvider {
    ...
    async handleSaveToMemory(payload) {
    ...
    async handleCreateGitHubIssue(payload) {
        try {
    ...
    async handleCreateGitHubPR(payload) {
        try {
